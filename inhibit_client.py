...
def process_action(filename):
    ...
    main_folder = "C://Users/a248433/Documents/SB Mozambique/EDO/Robotics/Bots/Automatização do Processo Abertura de contas Corporate/Clientes"
    ...
    text = f'Bot is starting at {time.ctime()}.'
    display_text_std(text)
    ...
    generated_CIF = driver.find_element(By.XPATH, '/html/body/div[3]/div[2]/form[1]/div[2]/table/thead/tr[2]/td/table/tbody/tr/td[2]/table/tbody/tr/td[2]/span')
    generated_CIF = generated_CIF.text
    text = f'{INDEXES.pop(0)}. Generated CIF {generated_CIF!r}.   {chr(482)}'
    display_text_std(text)

    # sociedade_constituida.update_val(filename, 'B1', generated_CIF)
    ...
    # Telefone_Celular_1 = str(client_sociedade.get_value('Telefone Celular.1')).replace('+', '')
    Telefone_Celular_1 = '258869402316'
    find_input_field_and_fill_value(
        driver, 
        input_value=Telefone_Celular_1,
        text_to_console='Telefone Celular.1',
        # x_path='/html/body/div[3]/div[2]/form[1]/div[4]/table/tbody/tr[1]/td/table/tbody/tr[77]/td[3]/input',
    ...
    find_input_field_and_fill_value(
        ...
        text_to_console='Customer Since',
        # x_path='/html/body/div[3]/div[2]/form[1]/div[4]/table/tbody/tr[1]/td/table/tbody/tr[100]/td[3]/input',
        x_path='/html/body/div[3]/div[2]/form[1]/div[4]/table/tbody/tr[1]/td/table/tbody/tr[108]/td[3]/input'
        )
    text = f'{INDEXES.pop(0)}. Bot inserted {now!r} under Customer Since.   {chr(482)}'
    # display_text_std(text)
    ...
    text = f'{INDEXES.pop(0)}. Bot inserted {Conservatoria!r} under Conservatoria.   {chr(482)}'
    display_text_std(text)
    ...
    for row in client_cif_df.df.itertuples():
        ...
        # print(path_name)
        tag = driver.find_element(By.XPATH, path_name)
        for char in NOME_da_PESSOA:
            tag.send_keys(char)
            time.sleep(0.0000001)
        ...
        tag = driver.find_element(By.XPATH, path_CIF)
        for char in NUMERO_DO_CLIENTE:
            tag.send_keys(char)
            time.sleep(0.0000001)
        # find_input_field_and_fill_value(
        # 	driver, 
    ...
    create_letter(driver, '129034', filename) #  generated_CIF)

    text = f'Bot is ending at {time.ctime()}.'
    display_text_std(text)
    elapsed_time = time.perf_counter() - start_time
    text = f'Bot process in {elapsed_time} seconds.'
    display_text_std(text)
...
# process_action(filename='C:/Users/a248433/Documents/SB Mozambique/EDO/Robotics/Bots/Automatização do Processo Abertura de contas Corporate/Clientes/pending/MOCHI LOGISTICA/data.xlsx')
